...
module NcsNavigator::Warehouse::Models::TwoPointTwo
  class SampleDist
    ...
    storage_names[:default] = 'sample_dist'
    ...
    property   :kits_to_distribute,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-4"] }
    property   :have_vacuum,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    property   :distrib_reas_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :reas_rf_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    ...
    mdes_order :psu_id, :sample_dist_id, :recruit_type, :du_id, :hh_id, :p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :kits_to_distribute, :have_vacuum, :distrib_reas_oth, :reas_rf_oth, :time_stamp_2
