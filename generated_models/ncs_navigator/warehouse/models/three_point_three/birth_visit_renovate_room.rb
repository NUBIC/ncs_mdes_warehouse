...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class BirthVisitRenovateRoom
    ...
    storage_names[:default] = 'birth_visit_renovate_room'
    ...
    belongs_to :bv,
               'NcsNavigator::Warehouse::Models::ThreePointThree::BirthVisit',
               :child_key => [ :bv_id ], :required => true
    property   :renovate_room,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "4", "5", "6", "7", "-5", "-1", "-2", "-4"] }

    mdes_order :psu_id, :bv_renovate_room_id, :bv_id, :renovate_room
