...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestNeighborhood
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_neighborhood'
    ...
    property   :core_quest_neighborhood_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_neighborhood_id, :p_id, :time_stamp_nc_st, :neigh_defn, :neigh_fam, :neigh_friend, :neighbors, :neigh_num_talk, :neigh_help, :neigh_talk, :neigh_watch_1, :neigh_watch_2, :neigh_close, :neigh_trust, :neigh_safe_1, :neigh_safe_2, :neigh_safe_3, :time_stamp_nc_et
