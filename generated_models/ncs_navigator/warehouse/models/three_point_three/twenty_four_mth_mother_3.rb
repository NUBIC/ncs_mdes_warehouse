...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwentyFourMthMother_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'twenty_four_mth_mother_3'
    ...
    property   :twenty_four_mth_mother_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twenty_four_mth_mother_3_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :time_stamp_2, :num_hh, :military_hh, :hhcomp_change, :hhcomp_change_mil, :other_change_roster, :num_change_hh, :military_hh_change, :time_stamp_9, :work_last_contact, :work_currently, :work_name_confirm, :work_name, :work_address_id, :work_address_1, :work_address_2, :work_unit, :work_city, :work_state, :work_zip, :work_zip4, :work_address_a_id, :work_address_1a, :work_address_2a, :work_unita, :work_citya, :work_statea, :work_zipa, :work_zip4a, :work_hrs, :r_smoke, :num_smoker, :smoke_rules, :drink, :drink_now, :drink_now_5, :time_stamp_10, :pets, :pet_meds, :pet_med_time, :time_stamp_11, :covers, :vacuum, :removal, :method, :method_oth, :air_filter, :open_window, :roach, :water, :mold, :renovate, :time_stamp_12, :recent_move, :age_home, :length_reside, :length_reside_unit, :water_drink, :water_drink_oth, :water_cook, :water_cook_oth, :neigh_defn, :neigh_fam, :neigh_friend, :neighbors, :neigh_num_talk, :neigh_help, :neigh_talk, :neigh_watch_1, :neigh_watch_2, :neigh_close, :neigh_trust, :neigh_safe_1, :neigh_safe_2, :neigh_safe_3, :time_stamp_13, :time_stamp_14
