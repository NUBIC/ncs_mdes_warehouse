...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherHousehold_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_household_3'
    ...
    property   :eighteen_mth_mother_household_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_3_id, :eighteen_mth_mother_household_3_id, :fname_hh, :child_relat, :child_relat_1_oth, :child_relat_2_oth, :hh_mem_dob, :active_duty, :branch_serv
