...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PrePregPrenovateRoom
    ...
    storage_names[:default] = 'pre_preg_prenovate_room'
    ...
    property   :pp_renovate_room_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :key => true, :required => true, :length => 1..36 }
    belongs_to :pp,
               'NcsNavigator::Warehouse::Models::ThreePointThree::PrePreg',
               :child_key => [ :pp_id ], :required => true
    ...
    mdes_order :psu_id, :pp_renovate_room_id, :pp_id, :renovate_room, :renovate_room_oth
