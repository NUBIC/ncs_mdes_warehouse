...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class BirthVisitHousehold_4
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'birth_visit_household_4'
    ...
    belongs_to :bv_4,
               'NcsNavigator::Warehouse::Models::ThreePointThree::BirthVisit_4',
               :child_key => [ :bv_4_id ], :required => true
    property   :birth_visit_household_4_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :p_id, :bv_4_id, :birth_visit_household_4_id, :fname_hh, :child_relat, :child_relat_1_oth, :child_relat_2_oth, :hh_mem_dob, :active_duty, :branch_serv
