...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwentyFourMthMotherHabits_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'twenty_four_mth_mother_habits_2'
    ...
    belongs_to :twenty_four_mth_2,
               'NcsNavigator::Warehouse::Models::ThreePointThree::TwentyFourMthMother_2',
               :child_key => [ :twenty_four_mth_2_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :twenty_four_mth_habits_2_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twenty_four_mth_2_id, :p_id, :twenty_four_mth_habits_2_id, :sleep_hrs_day, :sleep_hrs_night, :sleep_time_night, :sleep_time_wake, :sleep_difficult, :sleep_through, :tv_freq_hrs, :time_stamp_3, :childcare_change, :childcare, :family_care, :family_care_hrs, :homecare, :homecare_hrs, :daycare, :daycare_hrs, :time_stamp_4, :r_hcare, :c_health, :use_ic_log, :reason_no_ic_log, :reason_no_ic_log_oth, :num_prov_ic_log, :num_prov_rec, :last_visit, :visit_wt, :hospital, :admin_date, :hosp_nights, :diagnose, :diagnose_oth, :time_stamp_5, :cond_ear, :cond_wheeze, :cond_diarrhea, :fever, :asthma, :eyesight, :deaf, :ihmob, :time_stamp_6, :prescr_take, :otc_take, :suppl_take, :time_stamp_7, :insure, :ins_employ, :ins_medicaid, :ins_tricare, :ins_ihs, :ins_oth, :time_stamp_8, :lice_1, :lice_2, :lice_oth_1, :lice_oth_2, :smoke_hours
