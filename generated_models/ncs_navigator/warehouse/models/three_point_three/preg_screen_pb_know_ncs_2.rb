...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PregScreenPbKnowNcs_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'preg_screen_pb_know_ncs_2'
    ...
    property   :ps_pb_how_know_ncs_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :key => true, :required => true, :length => 1..36 }
    belongs_to :ps_pb,
               'NcsNavigator::Warehouse::Models::ThreePointThree::PregScreenPb_2',
    ...
    mdes_order :psu_id, :ps_pb_how_know_ncs_id, :ps_pb_id, :how_know_ncs, :how_know_ncs_oth
