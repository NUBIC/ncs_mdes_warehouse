...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class ThreeMthMotherChildHabits_4
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'three_mth_mother_child_habits_4'
    ...
    belongs_to :three_mth_mother_4,
               'NcsNavigator::Warehouse::Models::ThreePointThree::ThreeMthMother_4',
               :child_key => [ :three_mth_mother_4_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :three_mth_mother_child_habits_4_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
