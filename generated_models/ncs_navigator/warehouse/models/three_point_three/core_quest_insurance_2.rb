...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestInsurance_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_insurance_2'
    ...
    property   :core_quest_insurance_2_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_2_id, :core_quest_insurance_2_id, :p_id, :time_stamp_hi_st, :insure_confirm, :insure, :ins_employ, :ins_self, :ins_medicaid, :ins_tricare, :ins_ihs, :ins_medicare, :ins_oth, :ins_oth_oth, :ins_none, :ins_meet_needs, :time_stamp_hi_et
