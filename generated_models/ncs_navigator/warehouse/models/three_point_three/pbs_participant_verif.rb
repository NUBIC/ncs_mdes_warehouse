...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PbsParticipantVerif
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'pbs_participant_verif'
    ...
    property   :pbs_participant_verif_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :time_stamp_pbc_et,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..19, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9])?$/ }

    mdes_order :psu_id, :pbs_participant_verif_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_pbc_st, :mult_child, :child_num, :child_qnum, :c_fname, :c_lname, :child_sex, :resp_guard, :time_stamp_pbc_et
