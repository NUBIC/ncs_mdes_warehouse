...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherHabits_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_habits_2'
    ...
    belongs_to :eighteen_mth_mother_2,
               'NcsNavigator::Warehouse::Models::ThreePointThree::EighteenMthMother_2',
               :child_key => [ :eighteen_mth_mother_2_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :eighteen_mth_mother_habits_2_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_2_id, :p_id, :eighteen_mth_mother_habits_2_id, :time_stamp_3, :sleep_hrs_day, :sleep_hrs_night, :sleep_time_night, :sleep_time_wake, :sleep_difficult, :sleep_through, :tv_freq_hrs, :time_stamp_4, :childcare_change, :childcare, :family_care, :family_care_hrs, :homecare, :homecare_hrs, :daycare, :daycare_hrs, :time_stamp_5, :r_hcare, :c_health, :use_ic_log, :reason_no_ic_log, :reason_no_ic_log_oth, :num_prov_ic_log, :num_prov_rec, :last_visit, :visit_wt, :hospital, :admin_date, :hosp_nights, :diagnose, :diagnose_oth, :time_stamp_6, :cond_ear, :cond_wheeze, :cond_diarrhea, :fever, :asthma, :ihmob, :time_stamp_7, :prescr_take, :otc_take, :suppl_take, :time_stamp_8, :lice_1, :lice_oth_1, :lice_oth_2, :smoke_hours
