...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class NineMthMotherDetail
    ...
    storage_names[:default] = 'nine_mth_mother_detail'
    ...
    belongs_to :nine_mth,
               'NcsNavigator::Warehouse::Models::ThreePointThree::NineMthMother',
               :child_key => [ :nine_mth_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :nine_mth_detail_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
