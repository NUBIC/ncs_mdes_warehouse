...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PbsParticipantVerif_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'pbs_participant_verif_2'
    ...
    property   :pbs_participant_verif_2_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :pbs_participant_verif_2_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_pbc_st, :mult_child, :child_num, :time_stamp_pbc_et
