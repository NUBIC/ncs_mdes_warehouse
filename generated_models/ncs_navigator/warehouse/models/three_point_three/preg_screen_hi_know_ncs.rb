...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PregScreenHiKnowNcs
    ...
    storage_names[:default] = 'preg_screen_hi_know_ncs'
    ...
    belongs_to :ps_hi,
               'NcsNavigator::Warehouse::Models::ThreePointThree::PregScreenHi',
    ...
    mdes_order :psu_id, :ps_hi_how_know_ncs_id, :ps_hi_id, :how_know_ncs
