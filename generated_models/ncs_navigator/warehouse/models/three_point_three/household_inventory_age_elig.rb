...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class HouseholdInventoryAgeElig
    ...
    storage_names[:default] = 'household_inventory_age_elig'
    ...
    belongs_to :hh_inventory,
               'NcsNavigator::Warehouse::Models::ThreePointThree::HouseholdInventory',
               :child_key => [ :hh_inventory_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :household_inventory_age_elig_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
