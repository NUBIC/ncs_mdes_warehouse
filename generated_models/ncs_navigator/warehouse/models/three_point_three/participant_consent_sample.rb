...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class ParticipantConsentSample
    ...
    storage_names[:default] = 'participant_consent_sample'
    ...
    belongs_to :participant_consent,
               'NcsNavigator::Warehouse::Models::ThreePointThree::ParticipantConsent',
               :child_key => [ :participant_consent_id ], :required => true
    property   :participant_consent_sample_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :key => true, :required => true, :length => 1..36 }
    property   :sample_consent_type,
               NcsNavigator::Warehouse::DataMapper::NcsString,
