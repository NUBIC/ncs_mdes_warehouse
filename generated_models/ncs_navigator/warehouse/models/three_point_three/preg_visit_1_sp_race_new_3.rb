...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PregVisit1SpRaceNew_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'preg_visit_1_sp_race_new_3'
    ...
    mdes_order :psu_id, :pv1_sp_race_3_id, :pv1_3_id, :sp_race_new, :sp_race_new_oth
