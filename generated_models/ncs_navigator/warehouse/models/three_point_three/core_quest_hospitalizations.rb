...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestHospitalizations
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_hospitalizations'
    ...
    property   :core_quest_hospitalizations_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_hospitalizations_id, :p_id, :time_stamp_hl_st, :hosp_visit, :hosp_visit_num, :time_stamp_hl_et
