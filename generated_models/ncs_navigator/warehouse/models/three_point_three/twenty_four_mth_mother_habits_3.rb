...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwentyFourMthMotherHabits_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'twenty_four_mth_mother_habits_3'
    ...
    belongs_to :twenty_four_mth_mother_3,
               'NcsNavigator::Warehouse::Models::ThreePointThree::TwentyFourMthMother_3',
               :child_key => [ :twenty_four_mth_mother_3_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :twenty_four_mth_mother_habits_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
