...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestChildCare_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_child_care_2'
    ...
    property   :core_quest_child_care_2_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_2_id, :core_quest_child_care_2_id, :p_id, :time_stamp_cc_st, :childcare_change, :childcare, :family_care, :family_care_hrs, :homecare, :homecare_hrs, :daycare, :childcare_number, :childcare_type, :childcare_type_oth, :c_address_id, :c_address_1, :c_address_2, :c_unit, :c_city, :c_state, :c_zip, :c_zip4, :daycare_hrs, :time_stamp_cc_et
