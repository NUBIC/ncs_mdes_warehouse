...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PregScreenEhKnowNcs
    ...
    storage_names[:default] = 'preg_screen_eh_know_ncs'
    ...
    belongs_to :ps_eh,
               'NcsNavigator::Warehouse::Models::ThreePointThree::PregScreenEh',
    ...
    mdes_order :psu_id, :ps_eh_how_know_ncs_id, :ps_eh_id, :how_know_ncs
