...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherPrescr_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_prescr_3'
    ...
    property   :eighteen_mth_mother_prescr_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_3_id, :p_id, :eighteen_mth_mother_prescr_3_id, :prescrmed, :prescr_admin, :prescr_admin_oth, :prescr_takestill, :prescrip_freq, :prescrip_freq_unit
