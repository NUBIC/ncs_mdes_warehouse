...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestSmoke
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_smoke'
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_smoke_id, :p_id, :time_stamp_sm_st, :smoke, :smoke_home, :smoke_rules, :smoke_other, :time_stamp_sm_et
