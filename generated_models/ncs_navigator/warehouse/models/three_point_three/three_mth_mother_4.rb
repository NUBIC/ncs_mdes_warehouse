...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class ThreeMthMother_4
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'three_mth_mother_4'
    ...
    property   :three_mth_mother_4_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :three_mth_mother_4_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :time_stamp_2, :maristat, :educ, :hh_members, :num_child, :income_4cat, :time_stamp_3, :time_stamp_8
