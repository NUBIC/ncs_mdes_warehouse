...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwelveMthMotherMold_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'twelve_mth_mother_mold_3'
    ...
    property   :twelve_mth_mother_mold_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twelve_mth_mother_3_id, :twelve_mth_mother_mold_3_id, :p_id, :room_mold_child
