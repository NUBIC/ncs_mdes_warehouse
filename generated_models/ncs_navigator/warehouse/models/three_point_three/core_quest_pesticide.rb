...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestPesticide
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_pesticide'
    ...
    property   :core_quest_pesticide_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_pesticide_id, :p_id, :time_stamp_pa_st, :when_pest, :who_apply, :who_apply_oth, :apply_areas, :time_stamp_pa_et
