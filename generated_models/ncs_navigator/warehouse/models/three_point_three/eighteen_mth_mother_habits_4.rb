...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherHabits_4
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_habits_4'
    ...
    property   :eighteen_mth_mother_habits_4_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_4_id, :p_id, :eighteen_mth_mother_habits_4_id, :time_stamp_3, :sleep_hrs_day, :sleep_hrs_night, :sleep_time_night, :sleep_time_night_unit, :sleep_time_wake, :sleep_time_wake_unit, :sleep_difficult, :sleep_through, :tv_freq_hrs, :time_stamp_4, :childcare_change, :childcare, :family_care, :family_care_hrs, :homecare, :homecare_hrs, :daycare, :daycare_hrs, :time_stamp_5, :r_hcare, :r_hcare_oth, :c_health, :use_ic_log, :reason_no_ic_log, :reason_no_ic_log_oth, :num_prov_ic_log, :num_prov_rec, :last_visit_mm, :last_visit_dd, :last_visit_yy, :visit_wt, :hospital, :hospital_times, :time_stamp_6, :cond_ear, :cond_wheeze, :cond_diarrhea, :fever, :asthma, :ihmob, :time_stamp_7, :prescr_take, :otc_take, :suppl_take, :time_stamp_8, :lice_1, :lice_2, :lice_2_oth, :time_stamp_9, :work_last_contact, :work_currently, :work_hrs, :r_smoke, :num_smoker, :smoke_rules, :smoke_hours
