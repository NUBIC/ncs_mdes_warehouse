...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class ParticipantRvis
    ...
    property   :rvis_translate,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "3", "4", "5", "6", "-4"] }
    belongs_to :contact,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Contact',
    ...
    property   :rvis_sections,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-7", "-4"] }
    property   :rvis_during_interv,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-7", "-4"] }
    property   :rvis_during_bio,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-7", "-4"] }
    property   :rvis_bio_cord,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-7", "-4"] }
    property   :rvis_during_env,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-7", "-4"] }
    property   :rvis_during_thanks,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-4"] }
    property   :rvis_after_saq,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-7", "-4"] }
    property   :rvis_reconsideration,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :omittable => true, :length => 1..2, :set => ["1", "2", "-7", "-4"] }
