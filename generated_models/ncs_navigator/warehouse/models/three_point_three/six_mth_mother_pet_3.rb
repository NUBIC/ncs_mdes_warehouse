...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class SixMthMotherPet_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'six_mth_mother_pet_3'
    ...
    mdes_order :psu_id, :six_mth_mother_3_id, :six_mth_pet_3_id, :pet_type, :pet_type_oth
