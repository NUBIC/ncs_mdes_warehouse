...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class BirthVisitBabyName_4
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'birth_visit_baby_name_4'
    ...
    mdes_order :psu_id, :p_id, :bv_4_id, :baby_loop_4_id, :baby_bwt_lb, :baby_bwt_oz, :baby_ethnic_origin
