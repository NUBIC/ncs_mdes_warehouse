...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMother_4
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_4'
    ...
    property   :eighteen_mth_mother_4_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_4_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :time_stamp_2, :maristat, :num_hh, :military_hh, :hhcomp_change, :hhcomp_change_mil, :other_change_roster, :num_change_hh, :military_hh_change, :hh_members, :num_child, :income_4cat, :time_stamp_10, :pets, :pet_meds, :pet_med_time, :time_stamp_11, :removal, :method, :method_oth, :open_window, :roach, :water, :mold, :renovate, :time_stamp_12, :recent_move, :age_home, :length_reside, :length_reside_unit, :water_drink, :water_drink_oth, :water_cook, :water_cook_oth, :time_stamp_13, :neigh_defn, :neigh_fam, :neigh_friend, :neighbors, :neigh_num_talk, :neigh_help, :neigh_talk, :neigh_watch_1, :neigh_watch_2, :neigh_close, :neigh_trust, :neigh_safe_1, :neigh_safe_2, :neigh_safe_3, :time_stamp_14
