...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherRoomMold
    ...
    storage_names[:default] = 'eighteen_mth_mother_room_mold'
    ...
    property   :eighteen_mth_room_mold_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_room_mold_id, :eighteen_mth_mother_id, :room_mold, :room_mold_oth
