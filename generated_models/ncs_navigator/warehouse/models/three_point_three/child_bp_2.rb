...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class ChildBp_2
    ...
    storage_names[:default] = 'child_bp_2'
    ...
    mdes_order :psu_id, :child_bp_2_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_bp_st, :bp_intro, :resp_rel, :resp_rel_oth, :bp_equip_id, :bp_arm_used, :bp_upper_arm_length, :bp_mid_upper_arm_circ, :bp_cuff_size_used, :bp_sys_meas1, :bp_dia_meas1, :bp_pulse_meas1, :bp_position_meas1, :bp_state_meas1, :bp_sys_meas2, :bp_dia_meas2, :bp_pulse_meas2, :bp_position_meas2, :bp_state_meas2, :bp_sys_meas3, :bp_dia_meas3, :bp_pulse_meas3, :bp_position_meas3, :bp_state_meas3, :an_conv_weight_lbs, :an_conv_weight_oz, :an_conv_recumbent_length, :bp_calc, :bp_referral_level, :time_stamp_bp_et
