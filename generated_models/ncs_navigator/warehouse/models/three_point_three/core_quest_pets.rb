...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestPets
    ...
    storage_names[:default] = 'core_quest_pets'
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_pets_id, :p_id, :time_stamp_pt_st, :change_pets, :pets_home, :pet_meds, :pet_med_time, :pet_room_sleep, :pet_bedding, :livestock, :time_stamp_pt_et
