...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuestOccupation_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_occupation_2'
    ...
    property   :core_quest_occupation_2_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_2_id, :core_quest_occupation_2_id, :p_id, :time_stamp_occ_st, :work_last_contact, :work_currently, :work_hrs, :work_name_confirm, :work_name, :work_address_variables_confirm_new, :work_address_id, :work_address_1, :work_address_2, :work_unit, :work_city, :work_state, :work_zip, :work_zip4, :educ, :school_currently, :school_ft, :time_stamp_occ_et
