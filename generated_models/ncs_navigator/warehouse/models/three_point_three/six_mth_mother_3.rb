...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class SixMthMother_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'six_mth_mother_3'
    ...
    mdes_order :psu_id, :six_mth_mother_3_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :time_stamp_10, :pets, :pet_meds, :pet_med_time, :time_stamp_11, :rodent, :roach, :time_stamp_12, :neigh_defn, :neigh_fam, :neigh_friend, :neighbors, :neigh_num_talk, :neigh_help, :neigh_talk, :neigh_watch_1, :neigh_watch_2, :neigh_close, :neigh_trust, :neigh_safe_1, :neigh_safe_2, :neigh_safe_3, :time_stamp_13, :pay_bills, :wic, :food_stamp, :tanf, :time_stamp_14, :nonenglish_freq, :time_stamp_15, :income_10cat, :income2, :fam_support, :fam_support_num, :time_stamp_16, :time_stamp_17
