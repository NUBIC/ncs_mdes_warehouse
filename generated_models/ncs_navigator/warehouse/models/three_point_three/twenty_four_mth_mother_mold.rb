...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwentyFourMthMotherMold
    ...
    storage_names[:default] = 'twenty_four_mth_mother_mold'
    ...
    property   :twenty_four_mth_mother_mold_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twenty_four_mth_id, :p_id, :twenty_four_mth_mother_mold_id, :room_mold_child
