...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherMold_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_mold_3'
    ...
    property   :eighteen_mth_mother_mold_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_3_id, :p_id, :eighteen_mth_mother_mold_3_id, :room_mold_child
