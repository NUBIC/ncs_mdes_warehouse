...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class ParticipantVisConsent
    ...
    storage_names[:default] = 'participant_vis_consent'
    ...
    property   :vis_translate,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "4", "5", "6", "-4"] }
    property   :vis_comments,
