...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherDetail
    ...
    storage_names[:default] = 'eighteen_mth_mother_detail'
    ...
    property   :eighteen_mth_detail_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_id, :p_id, :eighteen_mth_detail_id, :child_qnum, :child_sex, :cname_confirm, :c_fname, :c_lname, :cdob_confirm, :child_dob
