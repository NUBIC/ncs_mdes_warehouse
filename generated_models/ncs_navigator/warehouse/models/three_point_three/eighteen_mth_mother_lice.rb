...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherLice
    ...
    storage_names[:default] = 'eighteen_mth_mother_lice'
    ...
    property   :eighteen_mth_mother_lice_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_id, :eighteen_mth_mother_lice_id, :lice_2
