...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherRenovateRoom
    ...
    storage_names[:default] = 'eighteen_mth_mother_renovate_room'
    ...
    property   :eighteen_mth_mother_renovate_room_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_id, :eighteen_mth_mother_renovate_room_id, :renovate_room, :renovate_room_oth
