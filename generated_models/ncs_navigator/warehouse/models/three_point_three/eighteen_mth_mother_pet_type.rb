...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherPetType
    ...
    storage_names[:default] = 'eighteen_mth_mother_pet_type'
    ...
    property   :eighteen_mth_mother_pet_type_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_id, :eighteen_mth_mother_pet_type_id, :pet_type, :pet_type_oth
