...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PregScreenPbKnowNcs
    ...
    storage_names[:default] = 'preg_screen_pb_know_ncs'
    ...
    belongs_to :ps_pb,
               'NcsNavigator::Warehouse::Models::ThreePointThree::PregScreenPb',
    ...
    mdes_order :psu_id, :ps_pb_how_know_ncs_id, :ps_pb_id, :how_know_ncs
