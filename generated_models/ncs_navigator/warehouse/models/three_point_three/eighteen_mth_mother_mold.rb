...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherMold
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_mold'
    ...
    property   :eighteen_mth_mother_mold_child_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_id, :p_id, :eighteen_mth_mother_mold_child_id, :room_mold_child
