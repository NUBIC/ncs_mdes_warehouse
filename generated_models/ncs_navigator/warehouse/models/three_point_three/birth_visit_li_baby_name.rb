...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class BirthVisitLiBabyName
    ...
    storage_names[:default] = 'birth_visit_li_baby_name'
    ...
    belongs_to :bv_li,
               'NcsNavigator::Warehouse::Models::ThreePointThree::BirthVisitLi',
               :child_key => [ :bv_li_id ], :required => true
    property   :birth_visit_li_baby_name_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :p_id, :bv_li_id, :birth_visit_li_baby_name_id, :baby_name, :baby_fname, :baby_mname, :baby_lname, :baby_sex, :baby_bwt_lb, :baby_bwt_oz
