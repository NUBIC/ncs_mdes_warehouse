...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class NonInterviewProviderRefusal
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'non_interview_provider_refusal'
    ...
    property   :nir_provider_refusal_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :key => true, :required => true, :length => 1..36 }
    belongs_to :non_interview_provider,
               'NcsNavigator::Warehouse::Models::ThreePointThree::NonInterviewProvider',
    ...
    mdes_order :psu_id, :nir_provider_refusal_id, :non_interview_provider_id, :refusal_reason_pbs, :refusal_reason_pbs_oth
