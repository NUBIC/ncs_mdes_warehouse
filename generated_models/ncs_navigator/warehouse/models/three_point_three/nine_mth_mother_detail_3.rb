...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class NineMthMotherDetail_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'nine_mth_mother_detail_3'
    ...
    belongs_to :nine_mth_mother_3,
               'NcsNavigator::Warehouse::Models::ThreePointThree::NineMthMother_3',
               :child_key => [ :nine_mth_mother_3_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :nine_mth_mother_detail_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :nine_mth_mother_3_id, :p_id, :nine_mth_mother_detail_3_id, :time_stamp_2, :eyes_follow, :smile, :reach_1, :feed, :wave, :grab, :switch_hands, :pickup, :hold, :sound_3, :speak_1, :speak_2, :headup, :roll_2, :situp, :stand, :stand_alone, :walk, :scribble, :fork_spoon, :time_stamp_3, :r_hcare, :r_hcare_oth, :c_health, :use_ic_log, :reason_no_ic_log, :reason_no_ic_log_oth, :num_prov_ic_log, :num_prov_rec, :last_visit_mm, :last_visit_dd, :last_visit_yy, :visit_wt, :same_care, :hcare_sick, :hcare_sick_oth, :hospital, :hospital_times, :time_stamp_4, :time_stamp_5
