...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class BirthVisitBabyName_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'birth_visit_baby_name_2'
    ...
    belongs_to :bv,
               'NcsNavigator::Warehouse::Models::ThreePointThree::BirthVisit_2',
               :child_key => [ :bv_id ], :required => true
    property   :baby_loop_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :p_id, :bv_id, :baby_loop_id, :baby_name, :baby_fname, :baby_mname, :baby_lname, :baby_sex, :baby_bwt_lb, :baby_bwt_oz
