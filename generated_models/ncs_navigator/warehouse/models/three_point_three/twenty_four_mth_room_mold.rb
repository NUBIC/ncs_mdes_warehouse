...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwentyFourMthRoomMold
    ...
    storage_names[:default] = 'twenty_four_mth_room_mold'
    ...
    property   :twenty_four_mth_room_mold_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twenty_four_mth_id, :twenty_four_mth_room_mold_id, :room_mold, :room_mold_oth
