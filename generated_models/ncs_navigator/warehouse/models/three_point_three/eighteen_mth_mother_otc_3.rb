...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class EighteenMthMotherOtc_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'eighteen_mth_mother_otc_3'
    ...
    property   :eighteen_mth_mother_otc_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :eighteen_mth_mother_3_id, :p_id, :eighteen_mth_mother_otc_3_id, :otcmed, :otc_admin, :otc_admin_oth, :otc_takestill, :otc_freq, :otc_freq_unit
