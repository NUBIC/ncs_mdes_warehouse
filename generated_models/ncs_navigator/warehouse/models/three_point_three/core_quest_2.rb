...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class CoreQuest_2
    ...
    storage_names[:default] = 'core_quest_2'
    ...
    mdes_order :psu_id, :core_quest_2_id, :recruit_type, :du_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key
