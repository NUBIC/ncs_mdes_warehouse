...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class PregScreenEhKnowNcs_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'preg_screen_eh_know_ncs_2'
    ...
    property   :ps_eh_how_know_ncs_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :key => true, :required => true, :length => 1..36 }
    belongs_to :ps_eh,
               'NcsNavigator::Warehouse::Models::ThreePointThree::PregScreenEh_2',
    ...
    mdes_order :psu_id, :ps_eh_how_know_ncs_id, :ps_eh_id, :how_know_ncs, :how_know_ncs_oth
