...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwentyFourMthPetType
    ...
    storage_names[:default] = 'twenty_four_mth_pet_type'
    ...
    property   :twenty_four_mth_pet_type_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twenty_four_mth_id, :twenty_four_mth_pet_type_id, :pet_type, :pet_type_oth
