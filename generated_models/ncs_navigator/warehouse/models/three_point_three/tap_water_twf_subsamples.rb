...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TapWaterTwfSubsamples
    ...
    storage_names[:default] = 'tap_water_twf_subsamples'
    ...
    property   :tap_water_twf_subsamples_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :tap_water_twf_id, :tap_water_twf_subsamples_id, :twf_subsamples
