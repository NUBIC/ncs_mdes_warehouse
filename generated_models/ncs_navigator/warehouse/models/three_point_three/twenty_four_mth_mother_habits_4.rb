...
module NcsNavigator::Warehouse::Models::ThreePointThree
  class TwentyFourMthMotherHabits_4
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'twenty_four_mth_mother_habits_4'
    ...
    belongs_to :twenty_four_mth_mother_4,
               'NcsNavigator::Warehouse::Models::ThreePointThree::TwentyFourMthMother_4',
               :child_key => [ :twenty_four_mth_mother_4_id ], :required => true
    belongs_to :p,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Participant',
               :child_key => [ :p_id ], :required => true
    property   :twenty_four_mth_mother_habits_4_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    belongs_to :work_address_a,
               'NcsNavigator::Warehouse::Models::ThreePointThree::Address',
               :child_key => [ :work_address_a_id ], :required => false
    property   :work_address_1a,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => true, :length => 0..100 }
    property   :work_address_2a,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => true, :length => 0..100 }
    property   :work_unita,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twenty_four_mth_mother_4_id, :p_id, :twenty_four_mth_mother_habits_4_id, :sleep_hrs_day, :sleep_hrs_night, :sleep_time_night, :sleep_time_night_unit, :sleep_time_wake, :sleep_time_wake_unit, :sleep_difficult, :sleep_through, :tv_freq_hrs, :time_stamp_3, :childcare_change, :childcare, :family_care, :family_care_hrs, :homecare, :homecare_hrs, :daycare, :daycare_hrs, :time_stamp_4, :r_hcare, :r_hcare_oth, :c_health, :use_ic_log, :reason_no_ic_log, :reason_no_ic_log_oth, :num_prov_ic_log, :num_prov_rec, :last_visit_mm, :last_visit_dd, :last_visit_yy, :visit_wt, :hospital, :hospital_times, :time_stamp_5, :cond_ear, :cond_wheeze, :cond_diarrhea, :fever, :asthma, :eyesight, :deaf, :ihmob, :time_stamp_6, :prescr_take, :otc_take, :suppl_take, :time_stamp_7, :insure, :ins_employ, :ins_medicaid, :ins_tricare, :ins_ihs, :ins_oth, :time_stamp_8, :lice_1, :lice_2, :lice_2_oth, :smoke_hours, :time_stamp_9, :work_last_contact, :work_currently, :work_name_confirm, :work_name, :work_address_id, :work_address_1, :work_address_2, :work_unit, :work_city, :work_state, :work_zip, :work_zip4, :work_address_a_id, :work_address_1a, :work_address_2a, :work_unita, :work_citya, :work_statea, :work_zipa, :work_zip4a, :work_hrs, :r_smoke, :num_smoker, :smoke_rules, :drink, :drink_now, :drink_now_5
