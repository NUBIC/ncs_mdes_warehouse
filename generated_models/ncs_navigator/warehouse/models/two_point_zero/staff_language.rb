...
module NcsNavigator::Warehouse::Models::TwoPointZero
  class StaffLanguage
    ...
    storage_names[:default] = 'staff_language'
    ...
    property   :staff_lang_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }

    mdes_order :psu_id, :staff_language_id, :staff_id, :staff_lang, :staff_lang_oth
