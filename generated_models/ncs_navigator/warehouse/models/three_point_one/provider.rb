...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class Provider
    ...
    mdes_order :psu_id, :provider_id, :provider_type, :provider_type_oth, :provider_ncs_role_oth, :provider_ncs_role, :practice_info, :name_practice, :practice_patient_load, :practice_size, :public_practice, :provider_info_source, :provider_info_source_oth, :provider_info_date, :provider_info_update, :provider_comment, :list_subsampling, :proportion_weeks_sampled, :proportion_days_sampled, :sampling_notes
