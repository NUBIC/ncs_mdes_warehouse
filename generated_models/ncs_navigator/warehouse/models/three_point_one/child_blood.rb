...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class ChildBlood
    ...
    storage_names[:default] = 'child_blood'
    ...
    property   :resp_rel,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-5", "-1", "-2", "-4"] }
    property   :resp_rel_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :refusal_reason,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "-5", "-1", "-2", "-4"] }
    property   :refusal_reason_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :hemophilia,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :blood_draw,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-1", "-2", "-3", "-4"] }
    property   :last_eat_time,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..5, :format => /^([0-9][0-9]:[0-9][0-9])?$/ }
    property   :last_eat_time_unit,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    property   :last_eat_date,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :collection_location_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :cblood_coll_date,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..10, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?$/ }
    property   :cblood_coll_time,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..5, :format => /^([0-9][0-9]:[0-9][0-9])?$/ }
    property   :cblood_coll_time_unit,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    ...
    property   :overall_comments,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "4", "5", "6", "7", "-2", "-3", "-4", "-5"] }
    ...
    property   :centrifuge_location,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-5", "-1", "-2", "-4"] }
    property   :centrifuge_location_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :equip_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..36 }
    property   :centrifuge_start_time,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..5, :format => /^([0-9][0-9]:[0-9][0-9])?$/ }
    property   :centrifuge_start_time_unit,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    property   :centrifuge_start_date,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..10, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?$/ }
    ...
    property   :cold_temp_measure,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "-5", "-7", "-3", "-4"] }
    property   :cold_temp_measure_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :cold_temp,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^(([-+]?\d{1,12})|([-+]?\d{0,12}\.\d{1,6})|(\d{0,12}\.\d{1,6})|([-+]?\d{1,12}\.\d{0,6}))?$/ }
    property   :cold_temp_posneg,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    ...
    property   :ambient_threshold_low,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "-3", "-4"] }
    property   :transport_comment,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    property   :transport_comment_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :blood_draw_comment,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    property   :blood_draw_comment_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    ...
    mdes_order :psu_id, :child_blood_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :blood_intro, :resp_rel, :resp_rel_oth, :refusal_reason, :refusal_reason_oth, :hemophilia, :blood_thinner, :chemo, :blood_draw, :last_eat_time, :last_eat_time_unit, :last_eat_date, :vitamin, :blood_complete, :time_stamp_2, :collection_location, :collection_location_oth, :cblood_coll_date, :cblood_coll_time, :cblood_coll_time_unit, :collection_status, :overall_comments, :overall_comments_oth, :time_stamp_3, :centrifuge_location, :centrifuge_location_oth, :equip_id, :centrifuge_start_time, :centrifuge_start_time_unit, :centrifuge_start_date, :centrifuge_end_time, :centrifuge_end_time_unit, :centrifuge_end_date, :centrifuge_temp_measure, :centrifuge_temp_measure_oth, :centrifuge_temp, :cent_temp_posneg, :blood_hemolyze, :centrifuge_comment, :centrifuge_comment_oth, :time_stamp_4, :cold_temp_measure, :cold_temp_measure_oth, :cold_temp, :cold_temp_posneg, :cold_threshold_low, :cold_threshold_high, :ambient_threshold_low, :transport_comment, :transport_comment_oth, :blood_draw_comment, :blood_draw_comment_oth, :time_stamp_5
