...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class TwelveMthMother_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'twelve_mth_mother_3'
    ...
    property   :twelve_mth_mother_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :twelve_mth_mother_3_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :time_stamp_8, :tannic_acid, :covers, :vacuum, :removal, :method, :method_oth, :air_filter, :open_window, :rodent, :roach, :water, :mold, :time_stamp_9, :renovate, :time_stamp_10, :cig_now, :num_smoker, :smoke_rules, :drink, :drink_now, :drink_now_5, :time_stamp_11, :neigh_defn, :neigh_fam, :neigh_friend, :neighbors, :neigh_num_talk, :neigh_help, :neigh_talk, :neigh_watch_1, :neigh_watch_2, :neigh_close, :neigh_trust, :neigh_safe_1, :neigh_safe_2, :neigh_safe_3, :time_stamp_12, :time_stamp_13
