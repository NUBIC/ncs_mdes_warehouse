...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class TwentyFourMthMother_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'twenty_four_mth_mother_2'
