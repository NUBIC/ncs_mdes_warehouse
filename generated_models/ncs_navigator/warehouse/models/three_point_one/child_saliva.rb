...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class ChildSaliva
    ...
    storage_names[:default] = 'child_saliva'
    ...
    property   :saliva_collect_option,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-3", "-4"] }
    property   :saliva_intro_parent,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "-1", "-3", "-4"] }
    property   :distribute,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :n_distrib_reas,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "-5", "-1", "-2", "-3", "-4"] }
    property   :n_distrib_reas_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :saliva_intro_collector,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "-1", "-3", "-4"] }
    property   :coll_refusal_reason,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "-1", "-2", "-3", "-4", "-5"] }
    property   :coll_refusal_reason_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    ...
    property   :no_specimen_reason_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :saliva_collector,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "-5", "-1", "-2", "-3", "-4"] }
    property   :saliva_collector_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :c_saliva_coll_date,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..10, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?$/ }
    property   :c_saliva_coll_time,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..5, :format => /^([0-9][0-9]:[0-9][0-9])?$/ }
    property   :c_saliva_coll_time_unit,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-1", "-2", "-3", "-4"] }
    ...
    mdes_order :psu_id, :child_saliva_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :saliva_collect_option, :saliva_intro_parent, :distribute, :specimen_id, :n_distrib_reas, :n_distrib_reas_oth, :saliva_intro_collector, :coll_refusal_reason, :coll_refusal_reason_oth, :last_eat_time, :last_eat_time_unit, :last_eat_date, :specimen_status, :no_specimen_reason, :no_specimen_reason_oth, :saliva_collector, :saliva_collector_oth, :c_saliva_coll_date, :c_saliva_coll_time, :c_saliva_coll_time_unit, :collection_comment, :collection_comment_oth, :time_stamp_2
