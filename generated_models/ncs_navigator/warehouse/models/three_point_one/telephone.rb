...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class Telephone
    ...
    storage_names[:default] = 'telephone'
    ...
    belongs_to :institute,
               'NcsNavigator::Warehouse::Models::ThreePointOne::Institution',
    ...
    property   :phone_info_source,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "4", "5", "6", "7", "-5", "-4"] }
    property   :phone_info_source_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :phone_info_date,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..10, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?$/ }
    property   :phone_info_update,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..10, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?$/ }
    property   :phone_nbr,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :phone_type,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "4", "5", "-5", "-1", "-6", "-4"] }
