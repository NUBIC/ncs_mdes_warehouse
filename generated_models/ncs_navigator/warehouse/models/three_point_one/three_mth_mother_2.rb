...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class ThreeMthMother_2
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'three_mth_mother_2'
    ...
    mdes_order :psu_id, :three_mth_2_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :mult_child, :child_num, :maristat, :educ, :ethnicity, :hh_members, :num_child, :income_4cat, :time_stamp_3, :hh_primary_lang, :person_lang_oth
