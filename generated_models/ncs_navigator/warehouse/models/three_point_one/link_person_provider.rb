...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class LinkPersonProvider
    ...
    storage_names[:default] = 'link_person_provider'
    ...
    mdes_order :psu_id, :person_provider_id, :provider_id, :person_id, :is_active, :prov_intro_outcome, :prov_intro_outcome_oth, :sampled_person, :pre_screening_status, :date_first_visit
