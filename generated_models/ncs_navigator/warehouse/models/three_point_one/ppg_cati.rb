...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class PpgCati
    ...
    storage_names[:default] = 'ppg_cati'
    ...
    mdes_order :psu_id, :ppg_cati_id, :recruit_type, :du_id, :p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :pregnant, :trying, :ppg_due_date_1, :date_period, :weeks_preg, :month_preg, :trimester, :med_unable, :time_stamp_2, :bst_nmbr, :phone_nbr, :time_stamp_3, :phone_type, :time_stamp_4
