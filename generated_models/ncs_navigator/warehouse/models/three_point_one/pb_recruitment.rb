...
module NcsNavigator::Warehouse::Models::ThreePointOne
  class PbRecruitment
    ...
    storage_names[:default] = 'pb_recruitment'
    ...
    belongs_to :provider,
               'NcsNavigator::Warehouse::Models::ThreePointOne::Provider',
