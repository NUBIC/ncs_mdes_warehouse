...
module NcsNavigator::Warehouse::Models::ThreePointZero
  class TapWaterTwfSaq
    ...
    storage_names[:default] = 'tap_water_twf_saq'
    ...
    property   :p_twf_2_collected_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :p_twf_0_collected,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "4", "-5", "-4"] }
    property   :p_twf_0_collected_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :p_twf_bottle_1_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..14 }
    property   :p_twf_bottle_2_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..14 }
    property   :p_twf_bottle_3_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..14 }
    property   :p_twf_date,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :p_twf_location,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "-5", "-1", "-2", "-4"] }
    property   :p_twf_location_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :pii => :possible, :length => 0..255 }
    property   :p_twf_filtered,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-1", "-2", "-4"] }
    property   :p_twf_own_hh,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "-1", "-2", "-4"] }

    mdes_order :psu_id, :tap_water_twf_saq_id, :recruit_type, :du_id, :hh_id, :p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :p_twf_n_collect, :p_twf_2_collected, :p_twf_2_collected_oth, :p_twf_0_collected, :p_twf_0_collected_oth, :p_twf_bottle_1_id, :p_twf_bottle_2_id, :p_twf_bottle_3_id, :p_twf_date, :p_twf_day, :p_twf_location, :p_twf_location_oth, :p_twf_filtered, :p_twf_own_hh
