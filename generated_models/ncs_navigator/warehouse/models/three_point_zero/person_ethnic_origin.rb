...
module NcsNavigator::Warehouse::Models::ThreePointZero
  class PersonEthnicOrigin
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'person_ethnic_origin'
    ...
    property   :person_ethnic_origin_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :ethnic_origin,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "4", "5", "-1", "-6", "-4"] }

    mdes_order :psu_id, :person_ethnic_origin_id, :person_id, :ethnic_origin
