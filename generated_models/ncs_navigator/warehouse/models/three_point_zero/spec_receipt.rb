...
module NcsNavigator::Warehouse::Models::ThreePointZero
  class SpecReceipt
    ...
    belongs_to :spsc,
               'NcsNavigator::Warehouse::Models::ThreePointZero::SpecSpscInfo',
    ...
    mdes_order :psu_id, :specimen_id, :spsc_id, :staff_id, :receipt_comment, :receipt_comment_oth, :receipt_dt, :cooler_temp, :monitor_status, :upper_trigger, :upper_trigger_lvl, :lower_trigger_cold, :lower_trigger_ambient, :storage_container_id, :centrifuge_comment, :centrifuge_comment_oth, :centrifuge_st, :centrifuge_et, :centrifuge_temperature, :centrifuge_staff_id, :equip_id
