...
module NcsNavigator::Warehouse::Models::ThreePointZero
  class IncidentUnanticipated
    ...
    storage_names[:default] = 'incident_unanticipated'
    ...
    property   :inc_unanticipated_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :key => true, :required => true, :length => 1..36 }
    belongs_to :incident,
               'NcsNavigator::Warehouse::Models::ThreePointZero::Incident',
               :child_key => [ :incident_id ], :required => true
    property   :inc_unanticipated,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "2", "3", "-4"] }

    mdes_order :psu_id, :inc_unanticipated_id, :incident_id, :inc_unanticipated
