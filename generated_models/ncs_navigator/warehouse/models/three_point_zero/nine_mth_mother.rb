...
module NcsNavigator::Warehouse::Models::ThreePointZero
  class NineMthMother
    ...
    mdes_order :psu_id, :nine_mth_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :mult_child, :child_num
