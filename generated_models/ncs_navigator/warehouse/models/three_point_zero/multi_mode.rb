...
module NcsNavigator::Warehouse::Models::ThreePointZero
  class MultiMode
    ...
    storage_names[:default] = 'multi_mode'
    ...
    mdes_order :psu_id, :multi_mode_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :time_stamp_2
