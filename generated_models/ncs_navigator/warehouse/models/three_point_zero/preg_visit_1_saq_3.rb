...
module NcsNavigator::Warehouse::Models::ThreePointZero
  class PregVisit1Saq_3
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'preg_visit_1_saq_3'
    ...
    mdes_order :psu_id, :pv1_saq_id, :recruit_type, :du_id, :p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_1, :planned, :month_try, :wanted, :timing, :father_name, :father_same_hh, :father_know_preg, :contact_f_now, :contact_f_later, :f_addr_id, :f_addr1_2, :f_addr_2_2, :f_unit_2, :f_city_2, :f_state_2, :f_zipcode_2, :f_zip4_2, :f_phone, :f_age, :time_stamp_2, :past_preg, :num_preg, :num_preg_subpreg, :age_first, :premature, :miscarry, :time_stamp_3, :cig_past, :cig_past_freq, :cig_past_num, :cig_now, :cig_now_freq, :cig_now_num, :drink_past, :drink_past_num, :drink_past_5, :drink_now, :drink_now_num, :drink_now_5, :time_stamp_4, :learn, :help, :incent, :research, :envir, :community, :know_others, :family, :doctor, :staff, :opin_spouse, :opin_family, :opin_friend, :opin_dr, :experience, :improve, :int_length, :int_stress, :int_repeat, :time_stamp_5
