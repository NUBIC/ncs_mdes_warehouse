...
module NcsNavigator::Warehouse::Models::ThreePointTwo
  class ReconsiderationIns
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'reconsideration_ins'
    ...
    property   :reconsideration_ins_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :instrument_repeat_key,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^([-+]?[\d]{1,9})?$/ }
    property   :time_stamp_rcs_st,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..19, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9])?$/ }
    property   :prev_sample_refuse,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :time_stamp_rcs_et,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :length => 0..19, :format => /^([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9])?$/ }

    mdes_order :psu_id, :reconsideration_ins_id, :recruit_type, :du_id, :p_id, :r_p_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :time_stamp_rcs_st, :prev_sample_refuse, :recon_bio, :recon_env, :readm_con, :time_stamp_rcs_et
