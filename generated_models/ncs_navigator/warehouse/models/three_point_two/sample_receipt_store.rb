...
module NcsNavigator::Warehouse::Models::ThreePointTwo
  class SampleReceiptStore
    ...
    storage_names[:default] = 'sample_receipt_store'
    ...
    property   :storage_compartment_area,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :temp_event_occurred,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :required => true, :length => 1..2, :set => ["1", "-3", "-4"] }
    property   :temp_event_action,
               NcsNavigator::Warehouse::DataMapper::NcsString,
