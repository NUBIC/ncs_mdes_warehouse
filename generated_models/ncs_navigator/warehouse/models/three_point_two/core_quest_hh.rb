...
module NcsNavigator::Warehouse::Models::ThreePointTwo
  class CoreQuestHh
    ...
    storage_names[:default] = 'core_quest_hh'
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_hh_id, :p_id, :time_stamp_hc_st, :core_intro, :num_hh, :military_hh, :hhcomp_change, :hhcomp_change_mil, :other_change_roster, :num_change_hh, :military_hh_change, :time_stamp_hc_et
