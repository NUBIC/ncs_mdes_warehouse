...
module NcsNavigator::Warehouse::Models::ThreePointTwo
  class PbSampFrame_2
    ...
    storage_names[:default] = 'pb_samp_frame_2'
    ...
    property   :payer_medicaid,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^([-+]?[\d]{1,9})?$/ }
    property   :payer_public,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^([-+]?[\d]{1,9})?$/ }
    property   :payer_private_commercial,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^([-+]?[\d]{1,9})?$/ }
    property   :payer_self,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^([-+]?[\d]{1,9})?$/ }
    property   :payer_other,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^([-+]?[\d]{1,9})?$/ }
    property   :payer_oth,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    property   :total_births_county,
               NcsNavigator::Warehouse::DataMapper::NcsString,
               { :format => /^([-+]?[\d]{1,9})?$/ }
    property   :pbs_frame_comments,
               NcsNavigator::Warehouse::DataMapper::NcsText,
               { :pii => :possible, :length => 0..1000 }

    mdes_order :psu_id, :pb_samp_frame_2_id, :recruit_type, :person_id, :event_id, :event_type, :event_repeat_key, :instrument_id, :instrument_type, :instrument_version, :instrument_repeat_key, :practice_num, :provider_id, :date_complete, :name_practice, :practice_address_id, :practice_address_1, :practice_address_2, :practice_unit, :practice_city, :practice_state, :practice_zip, :practice_zip4, :contact_fname, :contact_lname, :contact_position, :contact_address_id, :contact_address_1, :contact_address_2, :contact_unit, :contact_city, :contact_state, :contact_zip, :contact_zip4, :contact_email_id, :contact_email, :contact_phone_num_id, :contact_phone_num, :contact_phone_num_ext, :contact_preferred, :total_num_providers, :num_obgyn, :num_ob, :num_gyn, :num_fam_med, :num_midwives, :num_other_prov, :num_oth, :type_practice_new, :type_practice_oth, :all_prenatal_visits, :first_prenatal_visits, :first_prenatal_county, :num_births_location, :payer_tricare, :payer_medicaid, :payer_public, :payer_private_commercial, :payer_self, :payer_other, :payer_oth, :ethnicity_first_prenatal, :race_white, :race_black, :race_ai_an, :race_asian, :race_hawaiian_pi, :lang_english, :lang_spanish, :lang_other, :lang_oth, :under_20, :early_mid_20, :mid_late_20, :equal_30_more, :part_larger_practice, :name_larger_practice, :contact_fname_larger, :contact_lname_larger, :contact_position_larger, :contact_address_larger_id, :contact_address_larger_1, :contact_address_larger_2, :contact_unit_larger, :contact_city_larger, :contact_state_larger, :contact_zip_larger, :contact_zip4_larger, :contact_email_larger_id, :contact_email_larger, :contact_phone_num_larger_id, :contact_phone_num_larger, :contact_phone_num_larger_ext, :contact_preferred_larger, :total_num_locations, :total_num_births, :total_births_county, :pbs_frame_comments
