...
module NcsNavigator::Warehouse::Models::ThreePointTwo
  class CoreQuestInterimMed
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_interim_med'
    ...
    property   :core_quest_interim_med_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_interim_med_id, :p_id, :time_stamp_med_st, :prescr_take, :otc_take, :suppl_take, :homeopath_take, :time_stamp_med_et
