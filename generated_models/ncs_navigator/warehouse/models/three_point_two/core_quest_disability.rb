...
module NcsNavigator::Warehouse::Models::ThreePointTwo
  class CoreQuestDisability
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_disability'
    ...
    property   :core_quest_disability_id,
               NcsNavigator::Warehouse::DataMapper::NcsString,
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_disability_id, :p_id, :time_stamp_ds_st, :dis_deaf, :dis_blind, :time_stamp_ds_et
