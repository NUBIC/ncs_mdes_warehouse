...
module NcsNavigator::Warehouse::Models::ThreePointTwo
  class CoreQuestSleep
    include DataMapper::Resource
    include NcsNavigator::Warehouse::Models::MdesModel

    storage_names[:default] = 'core_quest_sleep'
    ...
    mdes_order :psu_id, :core_quest_id, :core_quest_sleep_id, :p_id, :time_stamp_sl_st, :sleep_room, :sleep_room_oth, :sleep_hrs_day, :sleep_hrs_night, :sleep_time_night, :sleep_time_night_unit, :sleep_time_wake, :sleep_time_wake_unit, :sleep_difficult, :sleep_through, :time_stamp_sl_et
